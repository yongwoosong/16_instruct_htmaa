...
class virtualMachine(machines.virtualMachine):
	...
	def initInterfaces(self):
		...
		else: self.fabnet = interfaces.gestaltInterface('FABNET', interfaces.serialInterface(baudRate = 115200, interfaceType = 'ftdi', portName = '/dev/tty.usbserial-FTXW9LMC'))
...
if __name__ == '__main__':
    ...
    # Making the manual setting on python code
